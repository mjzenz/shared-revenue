...
The current shared revenue scheme is quite effective at redistributing money from richer counties to poorer ones. The more fundamenta question is whether this is something that the state government should do.

The obvious alternative is local control over income taxes received in a county or municipality beyond what is used to provide state-wide services. In one sense this would be a fair system - resources would be given to the communities in which those taxpayers live.
